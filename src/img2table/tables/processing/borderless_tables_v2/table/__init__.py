...
from img2table.tables.processing.borderless_tables_v2.table.headers import process_headers
from img2table.tables.processing.borderless_tables_v2.table.table_creation import get_table

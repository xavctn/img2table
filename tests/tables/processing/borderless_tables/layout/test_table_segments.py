...
def test_get_table_areas() -> None:
    elements = [
        ...
        Cell(x1=10, y1=100, x2=20, y2=110),
        Cell(x1=30, y1=100, x2=40, y2=110),
        Cell(x1=50, y1=100, x2=60, y2=110),
        Cell(x1=10, y1=200, x2=20, y2=210),
    ...
    result = get_table_areas(segment=segment, char_length=4, median_line_sep=10)
    ...
    expected = [
        ImageSegment(
            ...
            whitespaces=[
                Whitespace(cells=[Cell(x1=6, y1=10, x2=10, y2=20)]),
        ...
        ImageSegment(
            ...
            x2=64,
            y2=50,
            elements=[Cell(x1=10, y1=40, x2=20, y2=50), Cell(x1=50, y1=40, x2=60, y2=50)],
            whitespaces=[
                Whitespace(cells=[Cell(x1=6, y1=40, x2=10, y2=50)]),
        ...
        ImageSegment(
            ...
            whitespaces=[
                Whitespace(cells=[Cell(x1=6, y1=100, x2=10, y2=110)]),
        ...
        ImageSegment(
            ...
            whitespaces=[
                Whitespace(cells=[Cell(x1=6, y1=200, x2=10, y2=210)]),
...
def test_coherent_table_areas() -> None:
    tb_area_1 = ImageSegment(
        x1=6,
        y1=10,
        x2=64,
        y2=20,
    ...
    assert coherent_table_areas(
        tb_area_1=tb_area_1, tb_area_2=tb_area_2, char_length=4, median_line_sep=10
    )
    assert not coherent_table_areas(
        tb_area_1=tb_area_1, tb_area_2=tb_area_3, char_length=4, median_line_sep=10
    )
    assert not coherent_table_areas(
        tb_area_1=tb_area_2, tb_area_2=tb_area_3, char_length=4, median_line_sep=10
    )


def test_table_segment_from_group() -> None:
    tb_group = [
        ImageSegment(
            x1=6,
            y1=10,
...
def test_get_table_segments() -> None:
    elements = [
        Cell(x1=10, y1=10, x2=20, y2=20),
        Cell(x1=30, y1=10, x2=40, y2=20),
        Cell(x1=50, y1=10, x2=60, y2=20),
